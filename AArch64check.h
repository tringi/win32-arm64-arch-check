...
namespace AArch64 {
    ...
    namespace Sets {
        ...
        static constexpr Feature v9_0_Minimal [] = { Features::DotProd, Features::FHM };
        static constexpr Feature v9_0_Relaxed [] = { Features::FP16, Features::RAS };
        static constexpr Feature v9_0_Strict  [] = { Features::FRINTTS, Features::SVE };
    ...
    const char * RegisterName (WORD register_) noexcept; // e.g.: "PFR0" for ID_AA64PFR0_EL1
    const char * FeatureName (Feature) noexcept;         // e.g.: "LSE" for FEAT_LSE
    ...
    //
    void SetWorkingData (const std::vector <std::map <std::uint16_t, std::uint64_t>> & alternative_dataset);
